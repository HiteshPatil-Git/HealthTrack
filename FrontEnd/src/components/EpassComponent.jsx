...
class EpassComponent extends Component {
    ...
    getPrescription(appId) {

        PrescriptionService.getPresByAppId(appId).then(
            res => {
                ...
                if (res.data === "") {
                    ...
                    this.props.history.push('/update-prescription');
                }
                ...
                render={({ errors, status, touched }) => (
                    <Form style={{
                        ...
                        <div className="form-group" style={{ marginRight: '20px', marginTop: '12px' }}>
                            ...
                            <a style={{ marginRight: '20px' }} class="btn btn-primary"
                                onClick={() => this.getPrescription(epassresponse.appId)} role="button">Prescribe</a>
